...
class AdminTestCase(BaseTestCase):
    ...
    def test_delete_post(self):
        response = self.client.get(
            url_for('admin.delete_post', post_id=1), follow_redirects=True)
        data = response.get_data(as_text=True)
    ...
    def test_delete_comment(self):
        response = self.client.get(
            url_for('admin.delete_comment', comment_id=1), follow_redirects=True)
        data = response.get_data(as_text=True)
    ...
    def test_enable_comment(self):
        ...
        response = self.client.post(
            url_for('admin.set_comment', post_id=1), follow_redirects=True)
        data = response.get_data(as_text=True)
    ...
    def test_approve_comment(self):
        ...
        data = response.get_data(as_text=True)
        self.assertIn(
            'Thanks, your comment will be published after reviewed.', data)
        self.assertNotIn('I am a guest comment.', data)

        self.login()
        response = self.client.post(
            url_for('admin.approve_comment', comment_id=2), follow_redirects=True)
        data = response.get_data(as_text=True)
    ...
    def test_new_category(self):
        ...
        response = self.client.post(url_for('admin.new_category'), data=dict(
            name='Tech'), follow_redirects=True)
        data = response.get_data(as_text=True)
        ...
        db.session.commit()
        response = self.client.get(
            url_for('blog.show_category', category_id=1))
        data = response.get_data(as_text=True)
    ...
    def test_edit_category(self):
        ...
        response = self.client.get(
            url_for('admin.edit_category', category_id=2))
        data = response.get_data(as_text=True)
    ...
    def test_delete_category(self):
        ...
        response = self.client.get(
            url_for('admin.delete_category', category_id=1), follow_redirects=True)
        data = response.get_data(as_text=True)
        ...
        response = self.client.post(
            url_for('admin.delete_category', category_id=2), follow_redirects=True)
        data = response.get_data(as_text=True)
    ...
    def test_delete_link(self):
        response = self.client.get(
            url_for('admin.delete_link', link_id=1), follow_redirects=True)
        data = response.get_data(as_text=True)
    ...
    def test_blog_setting(self):
        ...
        response = self.client.get(
            url_for('blog.about'), follow_redirects=True)
        data = response.get_data(as_text=True)
